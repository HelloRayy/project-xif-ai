...
export const defaultAdmins = [
  {
    ...
    nip: '19750618 200112 2 003',
    role: 'ADMIN',
    roleLabel: 'Guru BK / Koordinator Konseling & TU',
    email: 'bk.tu@sman6semarang.sch.id',
